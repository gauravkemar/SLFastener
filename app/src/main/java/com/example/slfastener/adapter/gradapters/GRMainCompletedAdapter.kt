...
class GRMainCompletedAdapter (private val editItem: (Int) -> Unit) :
    RecyclerView.Adapter<GRMainCompletedAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.gr_completed_main, parent, false)
