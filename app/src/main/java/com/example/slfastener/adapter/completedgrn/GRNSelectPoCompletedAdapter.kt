...
class GRNSelectPoCompletedAdapter (private val originalList: MutableList<GetSuppliersPOsDDLResponse>) :
    RecyclerView.Adapter<GRNSelectPoCompletedAdapter.ViewHolder>() {
